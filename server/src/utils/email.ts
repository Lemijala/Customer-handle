...
export const sendContactEmail = async (data: ContactEmailOptions): Promise<void> => {
  ...
  await transporter.sendMail({
    from: `Woyyuu Tech <${process.env.EMAIL_USER}>`,
    to: process.env.EMAIL_TO,
    subject: `New Inquiry from ${data.name} — Woyyuu Tech`,
    html: `
      <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; padding: 24px; border-radius: 12px;">
        <div style="background: linear-gradient(135deg, #3b82f6, #06b6d4); padding: 24px; border-radius: 10px; margin-bottom: 24px;">
          ...
          <p style="color: rgba(255,255,255,0.8); margin: 6px 0 0; font-size: 14px;">Woyyuu Tech — Software Studio</p>
        </div>
  ...
  await transporter.sendMail({
    from: `Woyyuu Tech <${process.env.EMAIL_USER}>`,
    to: data.email,
    subject: `We received your message — Woyyuu Tech`,
    html: `
      <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; padding: 24px; border-radius: 12px;">
        ...
        <div style="background: linear-gradient(135deg, #3b82f6, #06b6d4); padding: 32px 24px; border-radius: 10px; text-align: center; margin-bottom: 24px;">
          <img src="https://woyyuu-tech.vercel.app/profile.png" alt="Lemesa Girma" style="width: 64px; height: 64px; border-radius: 50%; border: 3px solid rgba(255,255,255,0.5); object-fit: cover; margin-bottom: 12px; display: block; margin-left: auto; margin-right: auto;" />
          ...
          <h1 style="color: white; margin: 0 0 6px; font-size: 26px; font-weight: 800;">Woyyuu Tech</h1>
        ...
        <div style="background: white; border-radius: 10px; padding: 28px; border: 1px solid #e2e8f0; margin-bottom: 16px;">
          ...
          <p style="color: #475569; line-height: 1.7; margin: 0 0 16px;">
            Thank you for reaching out to Woyyuu Tech. We've received your message and our team will review it shortly. You can expect a response from us within <strong>24 hours</strong>.
          </p>
        ...
        <div style="text-align: center; padding: 16px;">
          <p style="color: #94a3b8; font-size: 13px; margin: 0 0 12px;">Woyyuu Tech Software Studio · Addis Ababa, Ethiopia</p>
          <!-- Social Links -->
